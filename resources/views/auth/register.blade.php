            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="surname1" class="col-md-2 col-form-label text-md-end">{{ __('Apellido 1') }}</label>
                            ...
                            <label for="surname2" class="col-md-2 col-form-label text-md-end">{{ __('Apellido 2') }}</label>
