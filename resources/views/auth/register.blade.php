...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                <h2 class="text-center mb-4" style="color: #000000; font-weight: bold; font-family: 'Arial', sans-serif;">REGISTRO DE USUARIO</h2>
                    <div style="display: flex; justify-content: center; align-items: center;">
                        <img src="img\logos TFG\logo1b_sinfondo.png" alt="Logo" style="max-width: 200px; margin-bottom: 20px;">
</div>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end" style="color: #000000;">{{ __('Correo electrónico') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="cif" type="cif" class="form-control @error('cif') is-invalid @enderror" name="cif" required autocomplete="cif">
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end" style="color: #000000;">{{ __('Contraseña') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end" style="color: #000000;">{{ __('Confirmar contraseña') }}</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" style="background-color: #5F5F5F; color: #FFFFFF; border-color: #00ffff">
                                    {{ __('Registrarse') }}
                                </button>
                            </div>
                        </div>
